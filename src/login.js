...
class login extends Component {
    ...
    logusers() {
        var userlist = userDetails["users"][0];
        Object.keys(userlist).map((elem, iter) => {
            this.userMap.set(elem, userlist[elem])
            return this.userMap;
    ...
    formSubmit(event) {
        ...
        if (this.userMap.get(this.state.userName) !== undefined) {
            if (this.userMap.get(this.state.userName) !== this.state.password) {
                this.props.history.push(`/logout/${this.state.userName}`);
            } else {
                alert("Invalid login. Please check detail");
                    ...
                    <Row>
                        ...
                        <Col md="8"><div className="mainDiv">
                            ...
                            <div className="logo-div">
                                <img id="logo-img-id" src="./assets/cisco_logo2.png" alt="Logo"></img>
